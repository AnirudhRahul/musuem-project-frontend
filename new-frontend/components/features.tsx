      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4">Explore our process</h1>
            <p className="text-xl text-gray-600">
              We aim to simplify the complex data analysis techniques used by large corporations and make them accessible to museums of all sizes regardless of their techincal background.
            </p>
          </div>
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
              <div className="md:pr-4 lg:pr-12 xl:pr-16 mb-8">
                <h3 className="h3 mb-3">Our data pipeline</h3>
                <p className="text-xl text-gray-600">
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">Extract On Premises Data</div>
                    <div className="text-gray-600">
                      Our system of cameras and microcomputers used machine learning to track how visitors move through the museum, as well as which exhibits the look at.
                    </div>
                  </div>
              ...
              <div className="relative flex flex-col text-center lg:text-right">
                ...
                >
                  <div className="relative inline-flex flex-col">
                    ...
                    {/* <div className='black-glass md:max-w-none mx-auto rounded'> */}
                    
                    
                    <Image className="md:max-w-none mx-auto border-2  border-black" src={TrackingImg} width={500} height="462" alt="Features bg" />
